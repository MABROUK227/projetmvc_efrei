      ...
      <footer>
          ...
          <div class="line">
            <div class="margin">
              ...
              <div class="s-12 m-12 l-4 margin-m-bottom-30">
                <h3 class="text-size-16">Addresse de la companie</h3>
              ...
              <div class="s-12 m-12 l-4 margin-m-bottom-30">
                ...
                <p class="text-size-14">
                   mabroukadjaho@efrei.com<br>
                   mabroukadjaho@efrei.com
                </p>              
              </div>
              <!-- Collumn 3 -->
              <div class="s-12 m-12 l-4 ">
                <h3 class="text-size-16">Numero de telephone</h3>
                <p class="text-size-14">
                   +33 06-23-02-52-12<br>
                   +33 06-23-02-52-13<br>
                   +33 06-23-02-52-14
                </p>             
              </div>
            </div>
        ...
        <section class="padding background-dark full-width">
          <div class="text-center">
            <p class="text-size-12">Copyright 2019, Vision Design</p>
            <p class="text-size-12">Toutes les images sont achetées sur Bigstock. Ne pas utiliser les images sur votre site web.</p>
          </div>
        </section>
      </footer>
    </div>
